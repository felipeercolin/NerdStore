...
namespace NerdStore.Catalogo.Application.Services
{
    public class ProdutoAppService : IProdutoAppService
    {
        ...
        {
            if (!await _estoqueService.DebitarEstoque(id, quantidade)) throw new DomainException("Falha ao debitar estoque");
        ...
        {
            if (!await _estoqueService.ReporEstoque(id, quantidade)) throw new DomainException("Falha ao repor estoque");
