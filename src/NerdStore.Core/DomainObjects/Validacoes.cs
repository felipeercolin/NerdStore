...
namespace NerdStore.Core.DomainObjects
{
    public class Validacoes
    {
        ...
        {
            if(valor.Trim().Length > maximo) throw new DomainException(mensagem);
        }
        ...
        public static void ValidarSeVazio(object object1, string mensagem)
        {
        ...
        public static void ValidarSeMenorIgualMinimo(DateTime valor, DateTime minimo, string mensagem)
        {
            if (valor <= minimo) throw new DomainException(mensagem);
        }

        public static void ValidarSeFalo(bool valorBool, string mensagem)
        {
